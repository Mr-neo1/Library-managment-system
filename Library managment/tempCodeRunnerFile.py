...
def BookList():
    ...
    try:
        bookFile = open('D:\Library managment system\Library managment\src\BookList.txt')
        bookFile.close()
        ...
        bookListRoot.iconbitmap('D:\Library managment system\Library managment\src\Icon.ico')
        ...
        with open('D:\Library managment system\Library managment\src\BookList.txt') as bookListFileTreeview:
...
def SearchBook():
    ...
    try:
        ...
        bookSearchRoot.iconbitmap('D:\Library managment system\Library managment\src\Icon.ico')
...
def Search():
    ...
    if len(searchID) == 3:
        try:
            dicSearch = {}
            booksInfoSearch = getbooksinfo('D:\Library managment system\Library managment\src\BookList.txt' , dicSearch)
...
def BorrowBook(): 
    ...
    try:
        ...
        bookBorrowRoot.iconbitmap('D:\Library managment system\Library managment\src\Icon.ico')
...
def Borrow():
    ...
    if len(borrowID) == 3:
        try:
            dicBorrow = {}
            booksInfoBorrow = getbooksinfo('D:\Library managment system\Library managment\src\BookList.txt' , dicBorrow)
            if booksInfoBorrow[borrowID][-1] == 'not taken':
                new_file = []
                with open('D:\Library managment system\Library managment\src\BookList.txt' , 'r') as file:
                    for line in file:
                        if line[ : 3] == borrowID:
                ...
                file.close()
                with open('D:\Library managment system\Library managment\src\BookList.txt' , 'w') as file:
...
def ReturnBook(): 
    ...
    try:
        ...
        bookReturnRoot.iconbitmap('D:\Library managment system\Library managment\src\Icon.ico')
...
def Return():
    ...
    if len(returnID) == 3:
        try:
            dicReturn = {}
            booksInfoReturn = getbooksinfo('D:\Library managment system\Library managment\src\BookList.txt' , dicReturn)
...
def AddBook():
    ...
    bookAddRoot.iconbitmap('D:\Library managment system\Library managment\src\Icon.ico')
...
def Add():
    ...
    if len(bookTitle) != 0:
        if len(bookAuthor) != 0:
            lst1 = []
            bookInfoList = gettitleandauthor('D:\Library managment system\Library managment\src\BookList.txt' , lst1)
            ...
            if bookInfo in bookInfoList:
                ...
                bookID = getlastid('D:\Library managment system\Library managment\src\BookList.txt')
                if 99 > int(bookID) >= 9:
                ...
                bookList = open('D:\Library managment system\Library managment\src\BookList.txt' , 'a')
...
def DeleteBook(): 
    ...
    try:
        ...
        bookDeleteRoot.iconbitmap('D:\Library managment system\Library managment\src\Icon.ico')
...
def Delete():
    ...
    if len(deleteID) == 3:
        try:
            dicDelete = {}
            booksInfoDelete = getbooksinfo('D:\Library managment system\Library managment\src\BookList.txt' , dicDelete)
...
library_app.geometry('1000x900')
library_app.iconbitmap('D:\Library managment system\Library managment\src\Icon.ico')

#Background Image

backgroundImage =Image.open('D:\Library managment system\Library managment\src\Background.jpg')
...
welcomeLabel = Label(welcomeFrame, text='Welcome to CTU Library' , bg='black' , fg='white' , font=('Comic Sans MS' , 18))
